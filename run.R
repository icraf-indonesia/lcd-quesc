...
option_list = list(
  ...
  make_option(c("-b", "--year1"), type="numeric", default=NULL, help="initial period", metavar="character"), 
  make_option(c("-f", "--landcover2"), type="character", default=NULL, help="final land-cover", metavar="character"), 
  make_option(c("-e", "--year2"), type="numeric", default=NULL, help="final period", metavar="character"), 
