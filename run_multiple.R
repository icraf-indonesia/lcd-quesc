...
option_list = list(
  make_option(c("-w", "--workdir"), type="character", default=NULL, help="set working directory", metavar="character"), 
  make_option(c("-a", "--admin"), type="character", default=NULL, help="set working directory", metavar="character"), 
  make_option(c("-l1", "--landcover1"), type="character", default=NULL, help="set working directory", metavar="character"), 
  make_option(c("-y1", "--year1"), type="character", default=NULL, help="set working directory", metavar="character"), 
  make_option(c("-l2", "--landcover2"), type="character", default=NULL, help="set working directory", metavar="character"), 
  make_option(c("-y2", "--year2"), type="character", default=NULL, help="set working directory", metavar="character"), 
  make_option(c("-lt", "--landcover_table"), type="character", default=NULL, help="set working directory", metavar="character"), 
  make_option(c("-z", "--zone"), type="character", default=NULL, help="set working directory", metavar="character"), 
  make_option(c("-zt", "--zone_table"), type="character", default=NULL, help="set working directory", metavar="character"), 
  make_option(c("-cs", "--carbon_stock"), type="character", default=NULL, help="set working directory", metavar="character"), 
  make_option(c("-p", "--peat"), type="character", default=NULL, help="set working directory", metavar="character"), 
  make_option(c("-pt", "--peat_table"), type="character", default=NULL, help="set working directory", metavar="character"), 
  make_option(c("-b", "--burn"), type="character", default=NULL, help="set working directory", metavar="character"), 
  make_option(c("-o", "--output"), type="character", default="out.csv", help="output file name [default=%default%]", metavar="character"), 
)
...
# inPeat<-raster(peat)
# inBurn<-raster(peat)
inLandCover1<-raster(paste0(inRasterDirectory, "/", project, "/PL00_jabar.tif"))
inLandCover2<-raster(paste0(inRasterDirectory, "/", project, "/PL03_jabar.tif"))
inZone<-raster(paste0(inRasterDirectory, "/", project, "/Fungsikawasan_jabar.tif"))
